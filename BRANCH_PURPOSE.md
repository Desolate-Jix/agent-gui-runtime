...
## 用途 / Purpose
Omni、GUIActor 识别与学习审核接入。

Omni and GUIActor recognition / learning review integration.

## 状态 / Status
已合入根分支；不再平行开发 / Merged into root; no parallel development

这是旧源码归档，不是正式版已验收的声明。
This is an archival source branch, not a claim of formal release acceptance.

## 来源 / Source
- 原分支 / Original branch: `codex/omni-guiactor-learning`
- 原提交 / Original commit: `1cb1291edda746898be9896313a848f1cdc1eac6`
