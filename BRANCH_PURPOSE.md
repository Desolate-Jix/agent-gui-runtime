...
Vision provider capability, lineage and lease validation.

## 状态 / Status
尚未完整合入；不能当冗余删除 / Not fully merged; not redundant

这是旧源码归档，不是正式版已验收的声明。
This is an archival source branch, not a claim of formal release acceptance.

## 来源 / Source
- 原分支 / Original branch: `codex/provider-capability-contracts`
- 原提交 / Original commit: `576ed2d0740d64cbad825e201908bdadc65bc3bd`
