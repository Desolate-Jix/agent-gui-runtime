...
Shared runtime and native desktop formal development.

## 状态 / Status
唯一日常开发入口；工作副本仍有未提交实现 / Primary development entry; uncommitted implementation remains local

这是旧源码归档，不是正式版已验收的声明。
This is an archival source branch, not a claim of formal release acceptance.

## 来源 / Source
- 原分支 / Original branch: `codex/replay-v2`
- 原提交 / Original commit: `bc085dd800b0d5e18d0509c36f7c985d4756a815`
