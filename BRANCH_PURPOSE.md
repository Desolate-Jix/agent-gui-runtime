...
General UI recognition and privacy-safe 0.2.0 release.

## 状态 / Status
未合入当前分支；保留独立成果 / Not merged; retain separate results

这是旧源码归档，不是正式版已验收的声明。
This is an archival source branch, not a claim of formal release acceptance.

## 来源 / Source
- 原分支 / Original branch: `codex/general-ui-recognition`
- 原提交 / Original commit: `ce5a41a5905d17d1cf7148be207487f400f2b199`
