...
Hierarchical partitioning and coarse region proposal experiments.

## 状态 / Status
未合入当前分支；实验归档 / Not merged; experiment archive

这是旧源码归档，不是正式版已验收的声明。
This is an archival source branch, not a claim of formal release acceptance.

## 来源 / Source
- 原分支 / Original branch: `codex/hierarchical-region-mvp`
- 原提交 / Original commit: `320a92c50c3a83a120f449f56816e0b8d340fcba`
