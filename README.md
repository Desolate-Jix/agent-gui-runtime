...
> Implementation status: the checked-in CLI is replay/preflight-only in this worktree. Actual model startup remains guarded and is not asserted by the offline verification.
