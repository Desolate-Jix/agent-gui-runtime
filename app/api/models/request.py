...
class BindWindowRequest(BaseModel):
    ...
    handle: Optional[int] = Field(default=None, gt=0)
...
class ExecuteRecognitionPlanRequest(BaseModel):
    ...
    auto_observe_learning_artifacts: bool = False
