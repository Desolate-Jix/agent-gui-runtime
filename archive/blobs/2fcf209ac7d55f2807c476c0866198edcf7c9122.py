...
class InstantCommand(BaseModel):
    ...
    kind: Literal["discover", "launch", "select", "maximize", "capture", "read_text", "prepare_models", "release_models", "step", "input_sequence", "close_launched_window", "desktop_capture", "desktop_click"]
